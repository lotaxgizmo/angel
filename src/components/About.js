...
function About() {
    return (
        <div id='about' className='flex flex-col justify-center items-center lg:p-5d my-10 p-4 relative'>
            <img src={cloudleft} alt="" className='absolute -top-44 left-0 -z-10' />
            <img src={wing1} alt="" className='absolute -top-0 -right-0 -z-10' />
            <div className='bg-[#FFD401] flex flex-col justify-center items-center rounded-xl lg:rounded-[160px] lg:w-11/12 lg:p-4d  overflow-clip  border-black border-4'>
                <img src={whattxtmobile} alt="" className='flex lg:hidden w-64' />
                <img src={whattxt} alt="" className='lg:flex hidden wd-64' />
                <div className="divide flex flex-col lg:flex-row">
                    ...
                    <div className="right lg:w-6/12 flex flex-col justify-center items-start p-4 lg:p-10">
                        ...
                        <a href="#" target="_blank" rel="noopener noreferrer"><img src={buybtn} alt="" className='my-7' /></a>
